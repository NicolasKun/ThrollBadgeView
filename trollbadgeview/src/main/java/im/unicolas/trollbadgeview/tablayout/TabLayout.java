 ...
 * with this layout, you can call {@link #setupWithViewPager(LimitPagerView)} to link the two together.
...
public class TabLayout extends HorizontalScrollView {
     ...
     *
     * <p>This is the same as calling {@link #setupWithViewPager(LimitPagerView, boolean)} with
     * auto-refresh enabled.</p>
     *
     * @param viewPager the ViewPager to link to, or {@code null} to clear any previous link
     */
    public void setupWithViewPager(@Nullable LimitPagerView viewPager) {
     ...
     *                    content changes
     */
    public void setupWithViewPager(@Nullable final LimitPagerView viewPager, boolean autoRefresh) {
        setupWithViewPager(viewPager, autoRefresh, false);
    }

    private void setupWithViewPager(@Nullable final LimitPagerView viewPager, boolean autoRefresh,
    ...
    /**
     * @deprecated Use {@link #setupWithViewPager(LimitPagerView)} to link a TabLayout with a ViewPager
    ...
    protected void onAttachedToWindow() {
        ...
        if (mViewPager == null) {
            ...
            if (vp instanceof ViewPager) {
                ...
                setupWithViewPager((LimitPagerView) vp, true, true);
            }
        }
    }
    ...
    public class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public TabView(Context context) {
            ...
            ViewCompat.setPaddingRelative(this, 0, mTabPaddingTop,
                    0, mTabPaddingBottom);
     ...
     * not cause a leak.
     */
    public static class TabLayoutOnPageChangeListener implements LimitPagerView.OnPageChangeListener {
    ...
    public static class ViewPagerOnTabSelectedListener implements OnTabSelectedListener {
        private final LimitPagerView mViewPager;

        public ViewPagerOnTabSelectedListener(LimitPagerView viewPager) {
            mViewPager = viewPager;
        }
    ...
    private class AdapterChangeListener implements LimitPagerView.OnAdapterChangeListener {
        ...
        @Override
        public void onAdapterChanged(@NonNull LimitPagerView viewPager,
