...
/**
 * Created by unicolas on 2017/5/8.
 */

public class OldPagerView extends ViewGroup {
    ...
    public OldPagerView(Context context) {
        super(context);
        initViewPager();
    }

    public OldPagerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
